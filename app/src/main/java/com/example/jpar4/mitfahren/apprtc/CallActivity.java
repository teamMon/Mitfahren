  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    chattinghandler = new Handler() {
      ...
      public void handleMessage(Message msg) {
        if (msg.what == 3333) { //채팅거절
          String content = msg.getData().getString("content");
          String sender_name = msg.getData().getString("sender_name");
          Toast.makeText(CallActivity.this, sender_name+"님이 통화를 거절했습니다.", Toast.LENGTH_SHORT).show();
          onCallHangUp();
...
/*----------------------------------------서비스 바인딩 ----------------------------------------------------------------------------------------------------------------------------------------------------------------*/
 ...
 /*----------------------------------------서비스 바인딩 ----------------------------------------------------------------------------------------------------------------------------------------------------------------*/
  ...
  private void startCall() {
   ...
   //my logAndToast(getString(R.string.connecting_to, roomConnectionParameters.roomUrl));
  ...
  //my  logAndToast("Creating peer connection, delay=" + delta + "ms");
    VideoCapturer videoCapturer = null;
  ...
  public void onIceConnected() {
    ...
    runOnUiThread(new Runnable() {
      @Override
      public void run() {
        logAndToast("전화연결, delay=" + delta + "ms");
        iceConnected = true;
        callConnected();
      }
    });
