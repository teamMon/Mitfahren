  ...
  public View onCreateView(
    ...
    disconnectButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        Toast.makeText((Activity)callEvents, "통화를 종료합니다.", Toast.LENGTH_SHORT).show();
      }
    });
    ...
    cameraSwitchButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        callEvents.onCameraSwitch();
         Toast.makeText((Activity)callEvents, "카메라를 전환합니다.", Toast.LENGTH_SHORT).show();
      }
    });
    ...
    toggleMuteButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        toggleMuteButton.setBackgroundResource(enabled ? R.drawable.microphone :R.drawable.mutemicrophone);
        if(!enabled) Toast.makeText((Activity)callEvents, "음소거", Toast.LENGTH_SHORT).show();
      }
    });
