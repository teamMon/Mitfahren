 ...
 */
public class ChattingImageUploader {
    ...
    public static JSONObject uploadChattingImage(Bitmap imageBitmap, String img_file_name) {// sourceImageFile = imagePath
        ...
        try {
            ...
            Bitmap bResized = Bitmap.createScaledBitmap(imageBitmap, 400, 400, false);
            ...
            String folder_name = img_file_name.substring(0,img_file_name.lastIndexOf("/"));
            String filename = img_file_name.substring(img_file_name.lastIndexOf("/")); // ex) user_car_photo = qlql@qlqlcom/car_qlql.jpg
                                                                                                                    //(폴더명) / (파일명)
