package com.example.jpar4.mitfahren.imgaefilter;
...
/**
 * Created by jpar4 on 2017-11-18.
 */

public final class JJFilters {
private JJFilters() {
        }
        ...
        public static Filter SaturationSubfilter() {
                Filter filter = new Filter();
                filter.addSubFilter(new SaturationSubfilter(1.3f));
                return filter;
        }

        public static Filter ColorOverlaySubfilter() {
                Filter filter = new Filter();
                filter.addSubFilter(new ColorOverlaySubfilter(100, .2f, .2f, .0f));
                return filter;
        }

        public static Filter ContrastSubfilter() {
                Filter filter = new Filter();
                filter.addSubFilter(new ContrastSubfilter(1.2f));
                return filter;
        }

        public static Filter BrightnessSubfilter() {
                Filter filter = new Filter();
